<?php
 function activity_post_type() {
     ...
     $args = array(
          ...
          * set this to a string to control the exact name of the archive slug. (site.com/activities)
          */
         'has_archive'         => 'activities', // bool|string (defaults to FALSE)
          ...
          */
         'query_var'           => 'activity', // bool|string (defaults to TRUE - post type name)
     ...
     register_post_type(
         'activity', // Post type name. Max of 20 characters. Uppercase and spaces not allowed.
