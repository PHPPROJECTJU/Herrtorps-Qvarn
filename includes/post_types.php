<?php
 function aktivitet_post_type() {
     ...
     $args = array(
          ...
          */
         'has_archive'         => 'aktiviteter', // bool|string (defaults to FALSE)
          ...
          */
         'query_var'           => 'aktivitet', // bool|string (defaults to TRUE - post type name)
        ...
        /*'taxonomies'            => array( 'aktivitet_skill', 'aktivitet_type' ),*/
         'labels' => array(
             'name'               => __( 'Aktiviteter',                   'aktivitet-textdomain' ),
             'singular_name'      => __( 'Aktivitet',                    'aktivitet-textdomain' ),
             'menu_name'          => __( 'Aktiviteter',                   'aktivitet-textdomain' ),
             'name_admin_bar'     => __( 'Aktiviteter',                   'aktivitet-textdomain' ),
             'add_new'            => __( 'Lägg till Ny',                    'aktivitet-textdomain' ),
             'add_new_item'       => __( 'Lägg till Ny Aktivitet',            'aktivitet-textdomain' ),
             'edit_item'          => __( 'Redigera Aktivitet',               'aktivitet-textdomain' ),
             'new_item'           => __( 'Ny Aktivitet',                'aktivitet-textdomain' ),
             'view_item'          => __( 'Se Aktivitet',               'aktivitet-textdomain' ),
             'search_items'       => __( 'Sök Aktiviteter',            'aktivitet-textdomain' ),
             'not_found'          => __( 'Hittade inga aktiviteter',          'aktivitet-textdomain' ),
             'not_found_in_trash' => __( 'Hittade inga aktiviteter i papperskorgen', 'aktivitet-textdomain' ),
             'all_items'          => __( 'Alla Aktiviteter',               'aktivitet-textdomain' ),
         )
     );

     /* Register the post type. */
     register_post_type(
         'aktivitet', // Post type name. Max of 20 characters. Uppercase and spaces not allowed.
         $args      // Arguments for post type.
     );
 }

 /* Register custom post types on the 'init' hook. */
 add_action( 'init', 'aktivitet_post_type' );
  ...
  //------------------------NEXT POST TYPE
   ...
   function rum_post_type() {
       ...
       $args = array(
            ...
            * set this to a string to control the exact name of the archive slug. (site.com/aktiviteter)
            */
           'has_archive'         => 'rum', // bool|string (defaults to FALSE)

           /**
            * Sets the query_var key for this post type. If set to TRUE, the post type name will be used.
            * You can also set this to a custom string to control the exact key.
            */
           'query_var'           => 'rum', // bool|string (defaults to TRUE - post type name)
            ...
            * 'post_updated_messages' hook to customize those.
            */
          /*'taxonomies'            => array( 'rum_skill', 'rum_type' ),*/
           'labels' => array(
               'name'               => __( 'Rum',                   'Rum-textdomain' ),
               'singular_name'      => __( 'Rum',                    'aktivitet-textdomain' ),
               'menu_name'          => __( 'Rum',                   'aktivitet-textdomain' ),
               'name_admin_bar'     => __( 'Rum',                   'aktivitet-textdomain' ),
               'add_new'            => __( 'Lägg till nytt',                    'aktivitet-textdomain' ),
               'add_new_item'       => __( 'Lägg till nytt rum',            'aktivitet-textdomain' ),
               'edit_item'          => __( 'Redigera rum',               'aktivitet-textdomain' ),
               'new_item'           => __( 'Nytt rum',                'aktivitet-textdomain' ),
               'view_item'          => __( 'Se rum',               'aktivitet-textdomain' ),
               'search_items'       => __( 'Sök rum',            'aktivitet-textdomain' ),
               'not_found'          => __( 'Hittade inga rum',          'aktivitet-textdomain' ),
               'not_found_in_trash' => __( 'Hittade inga rum i papperskorgen', 'aktivitet-textdomain' ),
               'all_items'          => __( 'Alla rum',               'aktivitet-textdomain' ),
           )
       );

       /* Register the post type. */
       register_post_type(
           'rum', // Post type name. Max of 20 characters. Uppercase and spaces not allowed.
           $args      // Arguments for post type.
       );
   }

   /* Register custom post types on the 'init' hook. */
   add_action( 'init', 'rum_post_type' );
  /*<!--Lägg tilling a new custom post type
