     ...
     //------------------------NEXT POST TYPE
      ...
      function hogtid_post_type() {
          ...
          $args = array(
              ...
              'menu_icon'           => 'dashicons-star-empty', // string (defaults to use the post icon)
              ...
              'has_archive'         => 'hogtidpost', // bool|string (defaults to FALSE)

              'query_var'           => 'hogtidpost', // bool|string (defaults to TRUE - post type name)
             ...
             /*'taxonomies'            => array( 'boende_skill', 'boende_type' ),*/
              'labels' => array(
                  'name'               => __( 'Högtidposter',                   'Hogtid-textdomain' ),
                  'singular_name'      => __( 'Högtidpost',                    'hogtidpost-textdomain' ),
                  'menu_name'          => __( 'Högtidposter',                   'hogtidpost-textdomain' ),
                  'name_admin_bar'     => __( 'Högtidposter',                   'hogtidpost-textdomain' ),
                  'add_new'            => __( 'Lägg till ny',                    'hogtidpost-textdomain' ),
                  'add_new_item'       => __( 'Lägg till ny högtidpost',            'hogtidpost-textdomain' ),
                  'edit_item'          => __( 'Redigera högtidpost',               'hogtidpost-textdomain' ),
                  'new_item'           => __( 'Ny högtidpost',                'hogtidpost-textdomain' ),
                  'view_item'          => __( 'Se högtidpost',               'hogtidpost-textdomain' ),
                  'search_items'       => __( 'Sök högtidpost',            'hogtidpost-textdomain' ),
                  'not_found'          => __( 'Hittade inga högtidposter',          'hogtidpost-textdomain' ),
                  'not_found_in_trash' => __( 'Hittade inga högtidposter i papperskorgen', 'hogtidpost-textdomain' ),
                  'all_items'          => __( 'Alla högtidposter',               'hogtidpost-textdomain' ),
              )
          );

          /* Register the post type. */
          register_post_type(
              'hogtidpost', // Post type name. Max of 20 characters. Uppercase and spaces not allowed.
              $args      // Arguments for post type.
          );
      }

      /* Register custom post types on the 'init' hook. */
      add_action( 'init', 'hogtid_post_type' );
