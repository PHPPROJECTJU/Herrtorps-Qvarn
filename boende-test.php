...
function getTabs(){
  ...
  if( $query->have_posts() ) {
     while ( $query->have_posts() ) {
       ...
       ?>
  <div class="tab">
    <button class="tablinks" onclick="openTab(event, '<?php echo $rumstyp;?>')"><?php echo $rumstyp;?></button>
  </div>
...
var rumstyp = document.querySelector('.tablinks').innerHTML;
